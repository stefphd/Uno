...
#ifndef UNO_BYRDL1RELAXATION_H
#define UNO_BYRDL1RELAXATION_H
...
namespace uno {
   ...
   protected:
      ...
      Byrdl1Relaxation(const Model& model, l1RelaxedProblem&& feasibility_problem, l1RelaxedProblem&& l1_relaxed_problem, const Options& options);
