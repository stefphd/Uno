...
void Byrdl1Relaxation::initialize(Statistics& statistics, Iterate& initial_iterate, const Options& options) {
   // statistics
...
void Byrdl1Relaxation::switch_to_feasibility_problem(Statistics& /*statistics*/, Iterate& /*current_iterate*/) {
...
void Byrdl1Relaxation::solve_sequence_of_relaxed_subproblems(Statistics& statistics, Iterate& current_iterate, Direction& direction,
      WarmstartInformation& warmstart_information) {
...
void Byrdl1Relaxation::solve_subproblem(Statistics& statistics, const OptimizationProblem& problem, Iterate& current_iterate,
...
void Byrdl1Relaxation::solve_l1_relaxed_problem(Statistics& statistics, Iterate& current_iterate, Direction& direction,
...
void Byrdl1Relaxation::decrease_parameter_aggressively(Iterate& current_iterate, const Direction& direction) {
   ...
   if (this->trial_multipliers.not_all_zero(this->model.number_variables, this->small_duals_threshold)) {
      ...
      const double infeasible_dual_error = Byrdl1Relaxation::compute_infeasible_dual_error(current_iterate);
...
double Byrdl1Relaxation::compute_infeasible_dual_error(Iterate& current_iterate) {
   // stationarity error
...
void Byrdl1Relaxation::enforce_linearized_residual_sufficient_decrease(Statistics& statistics, Iterate& current_iterate, Direction& direction,
...
bool Byrdl1Relaxation::linearized_residual_sufficient_decrease(const Iterate& current_iterate, double linearized_residual,
...
void Byrdl1Relaxation::enforce_descent_direction_for_l1_merit(Statistics& statistics, Iterate& current_iterate, Direction& direction,
...
bool Byrdl1Relaxation::is_descent_direction_for_l1_merit_function(const Iterate& current_iterate, const Direction& direction,
...
void Byrdl1Relaxation::compute_primal_dual_residuals(Iterate& iterate) {
   ConstraintRelaxationStrategy::compute_primal_dual_residuals(this->l1_relaxed_problem, this->feasibility_problem, iterate);
}

void Byrdl1Relaxation::evaluate_progress_measures(Iterate& iterate) const {
...
ProgressMeasures Byrdl1Relaxation::compute_predicted_reduction_models(Iterate& current_iterate, const Direction& direction, double step_length) {
   return {
...
size_t Byrdl1Relaxation::maximum_number_constraints() const {
   return this->l1_relaxed_problem.number_constraints;
}

// for information purposes, check that l1 is an exact relaxation
void Byrdl1Relaxation::check_exact_relaxation(Iterate& iterate) const {
